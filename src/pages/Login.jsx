...
export default function Login() {
  ...
  function loginAsDemo(demoUsername) {
    login(demoUsername, 'demo123')
    ...
    <div className="flex min-h-screen items-center justify-center bg-ink-50 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-6 flex flex-col items-center gap-2 text-center">
          ...
          <p className="text-xs font-medium uppercase tracking-wide text-ink-400">Care Group</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            <div>
              ...
              <input
                ...
                required
                placeholder="jemaat / ketua / superadmin"
          ...
          <div className="flex flex-col gap-2">
            {demoUsers.map((u) => {
              ...
              return (
                <button
                  key={u.id}
                  onClick={() => loginAsDemo(u.username)}
